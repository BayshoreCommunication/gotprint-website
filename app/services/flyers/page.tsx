...
export default function FlyersPage() {
  ...
  const productData = {
    ...
    description:
      "Eye-catching flyers and brochures for your marketing campaigns. Perfect for events, promotions, and business advertising.",
  ...
  const calculatePrice = () => {
    ...
    // Add fold price
    const foldPrice =
      productData.folds.find((f) => f.value === selectedFold)?.price || 0;
    price += foldPrice;
    ...
    const quantityMultiplier =
      quantity <= 250 ? 1 : quantity <= 500 ? 0.85 : 0.75;
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Input
                      ...
                      value={quantity}
                      onChange={(e) =>
                        setQuantity(parseInt(e.target.value) || 25)
                      }
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="rush" className="font-medium">
                          Rush
                        </Label>
                      </div>
                      <div className="text-right">
                ...
                <div className="space-y-4">
                  ...
                  <div className="prose text-sm text-gray-600">
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      ...
                      <li>
                        Format: PDF preferred (AI, EPS, PSD also accepted)
                      </li>
                      <li>Color Mode: CMYK for print</li>
                      <li>Bleed: 0.125" on all sides</li>
                      <li>
                        Safe Area: Keep important text 0.125" from trim edge
                      </li>
