  ...
  const signTypes = [
    {
      ...
      features: ['18" x 24" Standard', "Corrugated Plastic", "Weather Resistant", "H-Stakes Included"],
    ...
    },
    {
      ...
      features: ["Multiple Sizes", "Full Color", "UV Resistant", "Fast Turnaround"],
      image: "/placeholder.svg?height=300&width=400",
      popular: false,
    },
    {
      ...
      features: ["Heavy Duty Material", "Custom Sizes", "Professional Design", "Durable Stakes"],
      image: "/placeholder.svg?height=300&width=400",
      popular: false,
    },
    {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl">
            Durable outdoor signage for real estate, political campaigns, contractors, and events. Weather-resistant
            materials ensure your message stays visible.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {signTypes.map((sign, index) => (
            <Card key={index} className={`relative ${sign.popular ? "ring-2 ring-blue-500" : ""}`}>
              {sign.popular && <Badge className="absolute -top-2 left-4 bg-blue-600 text-white">Most Popular</Badge>}
              <CardContent className="p-6">
                ...
                <div className="flex items-center space-x-2 mb-4">
                  <span className="text-2xl font-bold text-green-600">{sign.price}</span>
                  <span className="text-lg text-gray-400 line-through">{sign.originalPrice}</span>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {[1, 2, 3, 4, 5, 6].map((template) => (
                    <div key={template} className="group cursor-pointer">
                      ...
                      <h4 className="font-medium">Yard Sign Template {template}</h4>
                      <p className="text-sm text-gray-600">Professional outdoor signage</p>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <div className="space-y-6">
                  <div className="border-b border-gray-100 pb-6">
                    ...
                    <p className="text-gray-600">
                      Great quality yard signs for our real estate business. They hold up well in all weather
                      conditions.
                    </p>
                  </div>
                </div>
          ...
          <TabsContent value="faq" className="mt-6">
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold mb-2">How long do yard signs last outdoors?</h4>
                    <p className="text-gray-600">
                      Our signs are designed to last 6-12 months outdoors with proper care and normal weather
                      conditions.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600">
                      Yes, H-stakes are included with all yard sign orders at no extra cost.
                    </p>
                  </div>
                </div>
              </CardContent>
