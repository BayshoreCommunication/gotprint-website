      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl">
            Professional marketing materials that showcase your business. From
            simple flyers to complex tri-fold brochures, we help you communicate
                ...
                <div className="space-y-6">
                  <div className="border-b border-gray-100 pb-6">
                    ...
                    <p className="text-gray-600">
                      Outstanding quality tri-fold brochures! The colors came
                      out vibrant and the folding was perfect.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold mb-2">
                      What's the difference between tri-fold and bi-fold?
                    </h4>
                    <p className="text-gray-600">
                      Tri-fold brochures have two fold lines creating three
                      panels, while bi-fold has one fold creating two panels.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">
                    ...
                    <p className="text-gray-600">
                      Yes! We offer professional design services and have
                      templates available for quick customization.
                    </p>
                  </div>
                </div>
              </CardContent>
